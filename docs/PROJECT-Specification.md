...
* **데이터 소스:** 주식일봉(`ka10081`), 분봉(`ka10080`), 실시간 기세(`0A`), 체결(`00`), 호가잔량(`0D`).
* **핵심 임무:**
...
* **데이터 소스:** 실시간 프로그램(`0w`), 외인(`ka10008`), 기관(`ka10009`), 상위거래원(`ka10040`).
* **핵심 임무:**
...
* **데이터 소스:** 계좌평가(`kt00004`), 체결잔고(`kt00005`), 주문(`kt10000`), 우선호가(`0C`).
* **핵심 임무:**
